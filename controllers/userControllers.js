...
const verify = async (req, res) => {
  ...
  if (!user) throw HttpError(404, "Email not found or already verifed");

  await User.findByIdAndUpdate({ _id: user._id }, { verify: true, verificationCode: "" });
...
const resendVerify = async (req, res) => {
  ...
  if (user.verify) throw HttpError(400, "Email already verifed");
